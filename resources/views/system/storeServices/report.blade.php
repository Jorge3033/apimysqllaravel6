...
<h2>Reporte Servicios de tienda</h2>
...
@section('form')
    <div class="form" id="form">
        <span class="btn alert alert-info container" id="formInfo"> Alta Servicios de tienda</span>
...
<script src="{{ asset('/public/js/validations/tables/storeServices.js') }}"></script>
