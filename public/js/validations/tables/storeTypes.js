...
function formEdit(data,form){
  form.find('span').text('Modificar la Tipo de tienda '+data.name)
...
function responceEdit(data,form){
  ...
  form.find('span').text('Tipo de tienda modificada rerultados actualizados ');
  form.find('#id').val(data.id);
  form.find('#name').val(data.name);
  form.find('#description').val(data.description);
...
function responseUp(data){
  let dialog = bootbox.dialog({
                  title: 'Tipo de tienda '+data.name+' creada',
...
function clearForm(form,btnClear){
  btnClear.on('click', function() {
    form.find('span').text('Alta Tipo de tienda ');
    form.find('#id').val('');
    form.find('#name').val('');
